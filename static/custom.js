...
const initScrollSpy = () => {
    const waitForNodesLoadInterval = setInterval(() => {
        ...
        const scrollableContentContainer = document.querySelector("[class='col docItemCol_node_modules-@docusaurus-theme-classic-lib-theme-DocItem-Layout-styles-module']") 
