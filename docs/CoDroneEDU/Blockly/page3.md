...
---
<button id="functionButton">Junior-Senior</button>

<div id="junior_function" className='level3_body' >
...
<div id="senior_function" className='level3_body' style={{display : 'none'}}>
